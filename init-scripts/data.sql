...
--
-- Host: localhost    Database: trendista
-- ------------------------------------------------------
...
CREATE TABLE `address` (
  ...
  `is_shop_address` bit(1) DEFAULT NULL,
...
INSERT INTO `address` VALUES (_binary 'ÿƒ\ßö\æO=¨°-{¦úa¹','2025-11-03 13:17:08.502714',NULL,NULL,'3440','Quáº­n Nam Tá»« LiÃªm',_binary '',_binary '\0','A Nam','0909090909','201','HÃ  Ná»™i','Sá»‘ 1, NgÃµ 1, Phá»‘ Kim MÃ£','13010','PhÆ°á»ng XuÃ¢n PhÆ°Æ¡ng',_binary '¥øh|¨L\Z˜r¡c¨'),(_binary '\Şw\ë\0·C‘´Lf*¶:vU','2025-11-03 13:13:03.624646',NULL,NULL,'1484','Quáº­n Ba ÄÃ¬nh',_binary '',_binary '','NhÃ  riÃªng - Kim MÃ£','0909090909','201','HÃ  Ná»™i','Sá»‘ 1, NgÃµ 1, Phá»‘ Kim MÃ£','1A0105','PhÆ°á»ng Kim MÃ£',_binary '¬\ÏÙŸıA„J“\áø¹?');
...
INSERT INTO `auth_user_authority` VALUES (_binary '¬\ÏÙŸıA„J“\áø¹?',_binary 'SÆİ·\ÊF	_…zC½3i'),(_binary '¬\ÏÙŸıA„J“\áø¹?',_binary 'gU¼¹C\í¢ŒhŸ(ˆ9'),(_binary '¥øh|¨L\Z˜r¡c¨',_binary 'SÆİ·\ÊF	_…zC½3i'),(_binary '^bn7M×£/L\æJ^\Ï',_binary 'SÆİ·\ÊF	_…zC½3i'),(_binary '\çğ¨	HÏ‚f)3\Èöaõ',_binary 'SÆİ·\ÊF	_…zC½3i'),(_binary 'bø\r	\ĞI¡‹ |¥t\Ş',_binary 'SÆİ·\ÊF	_…zC½3i');
/*!40000 ALTER TABLE `auth_user_authority` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `auto_reply_config`
--

DROP TABLE IF EXISTS `auto_reply_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `auto_reply_config` (
  ...
  `deleted_at` datetime(6) DEFAULT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `auto_chat_enabled` bit(1) NOT NULL,
...
--
-- Dumping data for table `auto_reply_config`
--

LOCK TABLES `auto_reply_config` WRITE;
/*!40000 ALTER TABLE `auto_reply_config` DISABLE KEYS */;
INSERT INTO `auto_reply_config` VALUES (_binary 'ˆ¡cZ¾VOÛœ”y\Ú\ë\Ç\ê\Ü','2025-11-15 20:38:08.117862',NULL,NULL,_binary '',_binary '','Xin chÃ o! MÃ¬nh lÃ  trá»£ lÃ½ áº£o cá»§a Trendista Shop.','GENERAL');
/*!40000 ALTER TABLE `auto_reply_config` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `banners` VALUES (1,'2025-10-26 12:59:00.140000',NULL,NULL,'Black Friday Sale',_binary '','HERO'),(2,'2025-10-26 12:59:37.417000',NULL,'2025-11-02 17:06:56.263000','19/11 For Man',_binary '\0','HERO');
...
INSERT INTO `cart` VALUES (_binary '=Fw\r–QKÛ²r¯—q{û','2025-11-04 21:19:14.954954',NULL,NULL,0.00,NULL),(_binary 'P&2¨\å’Jô±pş³×¯\ÎO','2025-11-02 15:04:47.433000',NULL,'2025-11-20 16:28:28.591465',280000.00,_binary '¥øh|¨L\Z˜r¡c¨'),(_binary 'Z[p¯g\äDo‘QT\\C&pö','2025-11-04 21:20:14.815095',NULL,'2025-11-04 21:20:14.841095',0.00,_binary 'bø\r	\ĞI¡‹ |¥t\Ş'),(_binary 'ƒ4n\ç\áH¿6\Ö2\Í\ĞR®','2025-11-06 14:23:53.161150',NULL,NULL,0.00,NULL),(_binary '´\É\ÚöLB ³W=Àt3\â','2025-11-02 21:42:17.765101',NULL,'2025-11-02 21:42:17.779101',0.00,_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'Ğ§HgG§IÄ‰soö\Ê','2025-11-05 14:46:24.600458',NULL,'2025-11-05 14:46:24.617444',0.00,_binary '\çğ¨	HÏ‚f)3\Èöaõ');
...
INSERT INTO `cart-item` VALUES (_binary '„µ…d\ÑFµƒ…3\Ód–','2025-11-20 15:12:47.303228',NULL,'2025-11-20 15:42:02.738827',1,_binary '§ûó]gB©«`\ål‡f',_binary ':EüR\'RJc¡\æöVt\â4',280000.00,_binary 'P&2¨\å’Jô±pş³×¯\ÎO',_binary 'l\ákE-ıNn€\æ˜5;1\n¹');
...
CREATE TABLE `chat_conversation` (
  ...
  `deleted_at` datetime(6) DEFAULT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `guest_session_id` binary(16) DEFAULT NULL,
  `last_message_at` datetime(6) DEFAULT NULL,
  `started_at` datetime(6) DEFAULT NULL,
  `status` enum('ACTIVE','ARCHIVED','INACTIVE') DEFAULT NULL,
  `title` varchar(255) NOT NULL,
  `admin_id` binary(16) DEFAULT NULL,
  `user_id` binary(16) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK481jkn50my702p13fn8jd4u7b` (`admin_id`),
  KEY `FK6ko1b04hgyl915ojmomx3od32` (`user_id`),
  CONSTRAINT `FK481jkn50my702p13fn8jd4u7b` FOREIGN KEY (`admin_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK6ko1b04hgyl915ojmomx3od32` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_conversation` VALUES (_binary 'Ã•~\ÙZD@Š¶\Û\Ï\01','2025-11-18 11:43:20.212485',NULL,NULL,NULL,'2025-11-18 11:43:20.212485','2025-11-18 11:43:20.212485','ACTIVE','KhÃ¡ch hÃ ng: User Trendista',_binary '¬\ÏÙŸıA„J“\áø¹?',_binary '¥øh|¨L\Z˜r¡c¨');
...
CREATE TABLE `chat_message` (
  ...
  `type` enum('IMAGE','PRODUCT_LINK','TEXT') NOT NULL,
...
INSERT INTO `collection` VALUES (_binary '\\E\Ù±jG‰”‡&½•i ','2025-10-27 22:21:38.739000',NULL,'2025-10-27 22:22:07.440000','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1761578492/collections/BANNER%20COLLECTION%201800X600px%20CTA_e3f6e6df-69a1-4ce3-9613-604158e44875.png','<p>MÃ¹a láº¡nh nÄƒm nay, Trendista mang Ä‘áº¿n lÃ n giÃ³ má»›i vá»›i <strong>Bá»™ sÆ°u táº­p Thu ÄÃ´ng 2025</strong> â€“ nÆ¡i cÃ¡ tÃ­nh vÃ  phong cÃ¡ch giao hÃ²a. Tá»« Ã¡o khoÃ¡c oversized, boots cao cá»• Ä‘áº¿n nhá»¯ng layer Ä‘áº§y sÃ¡ng táº¡o, táº¥t cáº£ táº¡o nÃªn má»™t báº£n hÃ²a ca thá»i trang vá»«a phÃ³ng khoÃ¡ng, vá»«a tinh táº¿. ÄÃ¢y khÃ´ng chá»‰ lÃ  trang phá»¥c â€“ mÃ  lÃ  cÃ¡ch Trendista ká»ƒ cÃ¢u chuyá»‡n cá»§a ngÆ°á»i tráº»: tá»± do, khÃ¡c biá»‡t vÃ  luÃ´n dáº«n Ä‘áº§u xu hÆ°á»›ng.</p><hr><h3>âœ¨ </h3><p><strong>Trendista FW25</strong> â€“ Khi phong cÃ¡ch cháº¡m Ä‘áº¿n cáº£m xÃºc.<br>Sáº¯c thu â€“ hÆ¡i láº¡nh â€“ vÃ  báº¡n, trong nhá»¯ng thiáº¿t káº¿ khiáº¿n cáº£ mÃ¹a Ä‘Ã´ng pháº£i ngÆ°á»›c nhÃ¬n. â„ï¸âœ¨</p>','Bá»™ sÆ°u táº­p Thu ÄÃ´ng 2025',0,'bo-suu-tap-thu-ong-2025',_binary '','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1761578478/collections/BANNER%20COLLECTION%201000x1000CTA_43e6ef7e-6c9d-47b8-8aa2-471d27ddb1a9.webp'),(_binary 'ˆ‘	5£\ßO—]R¸Ğš/®','2025-10-27 22:24:09.220000',NULL,'2025-11-19 14:43:38.536259','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1761578643/collections/aokhoac-horizontal-12_4b8bb789-8e35-4a49-aa5c-7925a3b92d69.webp','<p><strong>Bá»™ sÆ°u táº­p Thu ÄÃ´ng 2025 â€“ Trendista</strong> lÃ  hÃ nh trÃ¬nh tÃ´n vinh váº» Ä‘áº¹p hiá»‡n Ä‘áº¡i trong tá»«ng Ä‘Æ°á»ng cáº¯t. Láº¥y cáº£m há»©ng tá»« sáº¯c thu tráº§m áº¥m vÃ  hÆ¡i thá»Ÿ láº¡nh láº½o cá»§a mÃ¹a Ä‘Ã´ng, bá»™ sÆ°u táº­p mang Ä‘áº¿n sá»± hÃ²a quyá»‡n giá»¯a cháº¥t liá»‡u cao cáº¥p, phom dÃ¡ng tinh táº¿ vÃ  gam mÃ u thá»i thÆ°á»£ng. Má»—i thiáº¿t káº¿ lÃ  tuyÃªn ngÃ´n vá» phong cÃ¡ch â€“ máº¡nh máº½, tá»± tin vÃ  Ä‘áº§y cuá»‘n hÃºt, dÃ nh cho ngÆ°á»i phá»¥ ná»¯ hiá»‡n Ä‘áº¡i khÃ´ng ngáº¡i kháº³ng Ä‘á»‹nh dáº¥u áº¥n riÃªng.</p>','Bá»™ sÆ°u táº­p Thu ÄÃ´ng 2025 â€“ Trendista',0,'bo-suu-tap-thu-dong-2025--trendista',_binary '','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1761578635/collections/hang-ban-chay-1000x670_d386e355-7928-4b35-b12d-83f4523a3ff0.webp');
...
DROP TABLE IF EXISTS `collection_tb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `collection_tb` (
  ...
  `thumbnail` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKm0k8brcjk5c21395wqyfos4g1` (`name`),
  UNIQUE KEY `UK2qu4yrj4ai32lsx5029ikq749` (`slug`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `collection_tb` WRITE;
/*!40000 ALTER TABLE `collection_tb` DISABLE KEYS */;
/*!40000 ALTER TABLE `collection_tb` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `discount` VALUES (_binary '\Ì\ëš\éCi®¯¯–\Zc','2025-11-19 10:00:07.077601',NULL,'2025-11-19 10:29:52.332525','TRENDISTA10','<p>Khuyá»…n mÃ£i 10% cho cÃ¡c sáº£n pháº©m Ä‘Æ°á»£c Ã¡p mÃ£</p>','PRODUCT','AMOUNT',10000.00,'2025-11-30 23:59:59.000000','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521196/discounts/BANNER-FLASH-SALE-5-20_2f551670.jpg',_binary '',0.00,NULL,NULL,'2025-11-19 00:00:00.000000',NULL),(_binary '4\\¥ß±Bp·\\\êÁó‚','2025-11-19 10:05:58.214029',NULL,'2025-11-19 10:43:39.220977','19THANG10','<p>Trendista chÃºc má»«ng ngÃ y quá»‘c táº¿ nam giá»›i. Giáº£m ngay 30% cho Ä‘Æ¡n hÃ ng tá»« 200k, tá»‘i Ä‘a 30k.</p>','ORDER','PERCENT',30.00,'2025-11-25 23:59:59.000000','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521546/promotions/BANNER-FLASH-SALE_0b8fa1ec.webp',_binary '',30000.00,NULL,200000.00,'2025-11-19 00:00:00.000000',NULL),(_binary 'Zı \é\ÉiOL©3+7\Ã]c6','2025-11-19 17:31:53.568921',NULL,NULL,'FREESHIP15','Free 15K fee shipping for order','SHIPPING','AMOUNT',15000.00,'2025-12-31 23:59:59.000000','url image for discount',_binary '',0.00,3,0.00,'2025-09-07 00:00:00.000000',100),(_binary 'i1Hm@<Jz‚Ğ¹oy\Z‘','2025-11-19 10:04:17.027909',NULL,NULL,'WELLCOME50','<p>Khuyá»…n mÃ£i chÃ o má»«ng khÃ¡ch hÃ ng má»›i. Giáº£m 50k cho Ä‘Æ¡n hÃ ng tá»« 200k</p>','ORDER','AMOUNT',50000.00,'2025-11-30 23:59:59.000000','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521447/promotions/BANNER-FLASH-SALE_6b325dd3.webp',_binary '',0.00,NULL,200000.00,'2025-11-19 00:00:00.000000',NULL),(_binary '~DqX¶ŠIg‚}V\Î+]±','2025-11-19 10:02:00.482790',NULL,'2025-11-20 15:41:03.453511','TRENDISTA20','<p>Khuyá»…n mÃ£i 20% tá»‘i Ä‘a 20k cho cÃ¡c sáº£n pháº©m Ä‘Æ°á»£c Ã¡p dá»¥ng</p>','PRODUCT','PERCENT',20.00,'2025-11-25 23:59:59.000000','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521312/discounts/BANNER-FLASH-SALE-5-20_7cea9326.jpg',_binary '',0.00,NULL,NULL,'2025-11-19 00:00:00.000000',NULL);
...
CREATE TABLE `notification` (
  ...
  `is_draft` bit(1) NOT NULL COMMENT 'Tráº¡ng thÃ¡i xuáº¥t báº£n draft/publish',
  `is_sent` bit(1) NOT NULL COMMENT 'Tráº¡ng thÃ¡i gá»­i',
  `scheduled_at` datetime(6) DEFAULT NULL COMMENT 'Lá»‹ch gá»­i thÃ´ng bÃ¡o',
  `title` varchar(500) NOT NULL,
  `type` enum('MARKETING','ORDER_STATUS','PAYMENT','PROMOTION','SECURITY','SYSTEM') NOT NULL,
  `created_by` binary(16) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKo69d2ri3h42ikav8wmqper84r` (`created_by`),
  CONSTRAINT `FKo69d2ri3h42ikav8wmqper84r` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notification` VALUES (_binary '®\Ş<(Cò¥\ål[š+','2025-11-06 14:28:58.658944',NULL,'2025-11-06 14:28:58.673750','Tá»« User Trendista: HÃº',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary '+j_¿4mMa±cId=»f\Ä','2025-11-06 16:01:34.573802',NULL,'2025-11-06 16:01:34.649083','Tá»« User Trendista: lá»—i',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary '-p×¬\ÑH¤„^…†\"Õ½','2025-11-06 14:23:53.161150',NULL,'2025-11-06 14:23:53.324487','Tá»« User Trendista: Xin chÃ o',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary '=V\Ç\ë#ˆB‡¡ajOtŸ\Æ','2025-11-06 14:26:31.899888',NULL,'2025-11-06 14:26:31.934085','Tá»« User Trendista: Thá»­ thÃ´ng bÃ¡o xem hoáº¡t Ä‘á»™ng khÃ´ng nhÃ©',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary 'L™mõN®c¬·ny£','2025-11-06 14:55:38.769932',NULL,'2025-11-06 14:55:38.887430','Tá»« User Trendista: Xin chÃ o shop',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary 'YÜµ*‰E5±\ÑÀ\ŞXœX\á','2025-11-06 14:28:23.278064',NULL,'2025-11-06 14:28:23.301242','Tá»« User Trendista: ÃŠ',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary 'l¼²^\ëB&†gRdZ-£','2025-11-06 15:01:38.605867',NULL,'2025-11-06 15:01:38.715397','Tá»« User Trendista: Xin chÃ o shop',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary 'pjU¾›I©Ô²¤2…ğ','2025-11-06 15:58:21.352810',NULL,'2025-11-06 15:58:21.385073','Tá»« User Trendista: tÃ´i khÃ´ng hiá»ƒu',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary 'u\Çr\ëP3C”WiQA§©','2025-11-06 14:28:41.430348',NULL,'2025-11-06 14:28:41.445447','Tá»« User Trendista: Chi váº­y shop',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary '`;=\ÍUKE¼\Ñe\rc4\Õ','2025-11-06 15:58:03.938528',NULL,'2025-11-06 15:58:03.983284','Tá»« User Trendista: hÃ£y nháº¯c theo tÃ´i',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary ';h6jF\îXZ\Õ\ë\n','2025-11-06 14:26:06.309950',NULL,'2025-11-06 14:26:06.330008','Tá»« User Trendista: Thá»­ thÃ´ng bÃ¡o xem hoáº¡t Ä‘á»™ng khÃ´ng nhÃ©',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary '…nnzö±F¦½\Ø7¾','2025-11-06 14:39:20.589357',NULL,'2025-11-06 14:39:20.603187','Tá»« User Trendista: ChÃ o chop',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary '…ŠÀi©MJŸŠ\Ë\"4’©*','2025-11-06 15:59:18.009770',NULL,'2025-11-06 15:59:18.032063','Tá»« User Trendista: lá»—i',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary 'y´\ë´!Aö‹/Š\Ú$U–','2025-11-07 16:23:14.565721',NULL,NULL,'Æ¯u Ä‘Ã£i mÃ¹a hÃ¨, giáº£m 50% cho Ä‘Æ¡n tá»« 500k',_binary '',_binary '\0','2025-11-07 09:09:58.246000','Æ¯u Ä‘Ã£i mÃ¹a hÃ¨','PROMOTION',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '²\Ì\êpHÆ¬\n\ï˜ğ°s\Ø','2025-11-06 14:40:05.802936',NULL,'2025-11-06 14:40:05.816637','Tá»« User Trendista: ChÃ o chop',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary '¾$\î£TúN–\İ+¼fv\ä·','2025-11-07 16:25:59.421847',NULL,NULL,'Æ¯u Ä‘Ã£i mÃ¹a hÃ¨, giáº£m 50% cho Ä‘Æ¡n tá»« 500k',_binary '',_binary '\0','2025-11-07 09:09:58.246000','Æ¯u Ä‘Ã£i mÃ¹a hÃ¨','PROMOTION',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'Å¹\äú³‘I~¶Óµ£»Z7','2025-11-06 15:58:53.394417',NULL,'2025-11-06 15:58:53.411213','Tá»« User Trendista: hÃ£y nÃ³i lÃ  báº¡n khÃ´ng hiá»ƒu',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²'),(_binary 'Ù»?ß£TMa”¶†\êÎ¶mK','2025-11-06 14:28:01.482682',NULL,'2025-11-06 14:28:01.502339','Tá»« User Trendista: test Ã¢m thanh',_binary '\0',_binary '',NULL,'Tin nháº¯n má»›i','SYSTEM',_binary '\ãu(Gˆ¢U\r–%¦²');
...
CREATE TABLE `notification_recipient` (
  ...
  `user_id` binary(16) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKti386qghvl46bm9gfdkv3hpnn` (`notification_id`,`user_id`),
  KEY `FKjk7b87yu2qcqfj27y9crlujv2` (`user_id`),
  CONSTRAINT `FKjk7b87yu2qcqfj27y9crlujv2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKsb691ohcapb481gtapcm6humu` FOREIGN KEY (`notification_id`) REFERENCES `notification` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notification_recipient` VALUES (_binary '\rkùúE_´¦L\n•Š',_binary '\0','2025-11-06 14:55:38.769932',_binary 'L™mõN®c¬·ny£',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '‰Y\ÖóNÚ†\ØZ©v|Õ',_binary '\0','2025-11-06 14:40:05.802936',_binary '²\Ì\êpHÆ¬\n\ï˜ğ°s\Ø',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '%6Y\ÍM\á…\Ê\Öu&¹f\Ö',_binary '\0','2025-11-06 15:58:21.352810',_binary 'pjU¾›I©Ô²¤2…ğ',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'E[C	(H\'¡O=Tñ\ç',_binary '\0','2025-11-06 14:28:23.278064',_binary 'YÜµ*‰E5±\ÑÀ\ŞXœX\á',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'F‡÷úú	A}•ƒŸ\ï\ÔX',_binary '\0','2025-11-06 15:01:38.606866',_binary 'l¼²^\ëB&†gRdZ-£',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'Il;\áF¿Jn ¤>5{û¬',_binary '\0','2025-11-06 14:28:58.658944',_binary '®\Ş<(Cò¥\ål[š+',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '`äš³`¥G›Šò\ã±=@',_binary '\0','2025-11-06 15:59:18.009770',_binary '…ŠÀi©MJŸŠ\Ë\"4’©*',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'aû\\pø\nHr\r¿¸\Ğ˜!',_binary '\0','2025-11-06 14:26:06.309950',_binary ';h6jF\îXZ\Õ\ë\n',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary ' PÅLô@™]Œ{‘',_binary '\0','2025-11-06 15:58:03.938528',_binary '`;=\ÍUKE¼\Ñe\rc4\Õ',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '¢\èz&ÀEW¯\àyƒüt',_binary '\0','2025-11-06 16:01:34.574803',_binary '+j_¿4mMa±cId=»f\Ä',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '«”š%­G@ò¸\è—–V',_binary '\0','2025-11-06 14:39:20.589357',_binary '…nnzö±F¦½\Ø7¾',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '¶¼\ÜJ³7HmF¡\Ü\È-\İ',_binary '\0','2025-11-06 14:28:01.482682',_binary 'Ù»?ß£TMa”¶†\êÎ¶mK',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '¸Ï›26ÁC+½ºµVq²×®',_binary '\0','2025-11-06 15:58:53.394417',_binary 'Å¹\äú³‘I~¶Óµ£»Z7',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'Î½g\ì\ã\ÖIj¢#\Ñ\ÏI`»',_binary '\0','2025-11-06 14:26:31.899888',_binary '=V\Ç\ë#ˆB‡¡ajOtŸ\Æ',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '\Öc†x1¾Lß½;¬‡\Í6¬',_binary '\0','2025-11-06 14:28:41.430348',_binary 'u\Çr\ëP3C”WiQA§©',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary '\è-?ø\'AK\Ô>_Úš“',_binary '\0','2025-11-06 14:23:53.161150',_binary '-p×¬\ÑH¤„^…†\"Õ½',_binary '¬\ÏÙŸıA„J“\áø¹?');
...
CREATE TABLE `order_discount` (
  ...
  `discount_id` binary(16) NOT NULL,
  KEY `FKc8k78pwub3wbsnsgb0ccqdrw8` (`discount_id`),
...
INSERT INTO `order_item` VALUES (_binary '„•\×	úN½•\r\ãÕ±Æ´','2025-11-20 11:12:00.213002',NULL,NULL,290000.00,_binary '*\Û)\Ï6O`–MNW›G–¿',1,_binary '\á\ÆÏ¼=GgŠi\Ğö™®™',_binary '\Ï(„!9FçŠ§\nGCm\Û4');
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('COD','MOMO','QR') DEFAULT NULL,
...
INSERT INTO `orders` VALUES (_binary 'I±pPo\×Nü®=\à\È_\ì@','2025-11-03 13:21:15.234715',NULL,NULL,NULL,'2025-11-03 13:31:14.670301','Thanh toÃ¡n QR',874670,'2025-11-03 13:21:14.670301','PENDING','QR',NULL,5000.00,_binary 'ÿƒ\ßö\æO=¨°-{¦úa¹',_binary '¥øh|¨L\Z˜r¡c¨'),(_binary '\á\ÆÏ¼=GgŠi\Ğö™®™','2025-11-20 11:12:00.210001',NULL,'2025-11-20 11:13:02.043520',NULL,'2025-11-20 11:21:59.783724','Giao há»a tá»‘c',919783,'2025-11-20 11:11:59.783724','DELIVERED','MOMO',NULL,290000.00,_binary 'ÿƒ\ßö\æO=¨°-{¦úa¹',_binary '¥øh|¨L\Z˜r¡c¨'),(_binary '´	5®K-I¯–ø´¦T4ñ]','2025-11-03 13:35:09.514962',NULL,'2025-11-03 13:59:53.204497',NULL,'2025-11-03 13:45:09.125782','Thanh toÃ¡n QR',709125,'2025-11-03 13:35:09.125782','DELIVERED','QR','L4U8EM',120000.00,_binary 'ÿƒ\ßö\æO=¨°-{¦úa¹',_binary '¥øh|¨L\Z˜r¡c¨');
...
INSERT INTO `payment` VALUES (_binary 's\Æ\Ö\ÄHD(¥wQ‘IMS\î','2025-11-20 11:12:00.213002',NULL,'2025-11-20 11:13:02.043520',290000,'2025-11-20 11:12:58.922261','https://test-payment.momo.vn/v2/gateway/pay?t=TU9NT1ZKSkgyMDI1MDcyOF9URVNUfDkxOTc4Mw&s=5b4f7fb0b8e67ed8f4756825aa2a40d9a0b5b00a20fc16ec4c99115d87458983',NULL,'MOMO','CANCELLED',NULL,919783,_binary '\á\ÆÏ¼=GgŠi\Ğö™®™'),(_binary '–÷OPı9Hª‹»†\ÒÑšõ','2025-11-03 13:21:15.234715',NULL,NULL,5000,NULL,'https://pay.payos.vn/web/ef1a39a42db14350b4f426275ba49fa2',NULL,'QR','PENDING','00020101021238590010A000000727012900069704180115V3CAS51207789820208QRIBFTTA5303704540450005802VN62330829CSZTZL5P596 TT HOA DON 874670630433E2',874670,_binary 'I±pPo\×Nü®=\à\È_\ì@'),(_binary '\ïü\â\ÎL­xRakf¹','2025-11-03 13:35:09.522439',NULL,'2025-11-03 13:36:07.421652',120000,'2025-11-03 13:36:03.995546','https://pay.payos.vn/web/0de6ee2c03ad4c3bb4559749181ef32e',NULL,'QR','CANCELLED','00020101021238590010A000000727012900069704180115V3CAS51207789820208QRIBFTTA530370454061200005802VN62330829CSQLXNS9GU8 TT HOA DON 7091256304D3FB',709125,_binary '´	5®K-I¯–ø´¦T4ñ]');
...
INSERT INTO `product` VALUES (_binary 'l\ákE-ıNn€\æ˜5;1\n¹','2025-11-19 10:17:35.227916',NULL,'2025-11-20 15:41:03.453511','VGC981','<p>Quáº§n kaki nam cÃ´ng sá»Ÿ cháº¥t liá»‡u cao cáº¥p, form dÃ¡ng cá»±c Ä‘áº¹p.</p><img src=\"https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522171/products/product-1763522170610/quan-kaki-nam-QKM6017-DEN-1_21f5c0da.webp\" alt=\"\">','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522101/products/quan-kaki-nam-QKM6017-DEN-1_fdbfbe1f.webp',_binary '','Quáº§n kaki nam cÃ´ng sá»Ÿ',350000.00,280000.00,0,0,'quan-kaki-nam-cong-so',_binary '','Quáº§n kaki nam cÃ´ng sá»Ÿ cháº¥t liá»‡u cao cáº¥p','NEW_ARRIVALS',0,54,_binary '\çN‰²gğ“VŠµ£§',NULL),(_binary 'š»¾A£JrŒÎ…JB\ÔbÁ','2025-11-19 10:14:23.781261',NULL,'2025-11-19 14:43:38.536259','RDB405','<p>Ão phao nam cá»§a nhÃ  Trendista, vá»›i cháº¥t  liá»‡u cao cáº¥p form dÃ¡ng Ä‘áº¹p.</p><img src=\"https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522053/products/product-1763522053894/ao-phao-nam-PHM7009-REU-1_060320fc.webp\" alt=\"\">','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521890/products/ao-phao-nam-PHM7009-REU-1_041c4316.webp',_binary '','Ão phao nam cháº¥t liá»‡u cao cáº¥p',400000.00,390000.00,0,0,'ao-phao-nam-chat-lieu-cao-cap',_binary '','Ão phao nam cháº¥t liá»‡u cao cáº¥p Trendista','TRENDING',0,12,_binary '\çMû²gğ“VŠµ£§',_binary 'ˆ‘	5£\ßO—]R¸Ğš/®'),(_binary '\Ï(„!9FçŠ§\nGCm\Û4','2025-11-19 10:09:39.027247',NULL,'2025-11-19 14:43:38.536259','QSR780','<p>Ão KhoÃ¡c Nam MÅ© Liá»n LÃ³t LÃ´ng, cháº¥t liá»‡u cao cáº¥p. Xu hÆ°á»›ng nÄƒm 2025.</p><img src=\"https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521632/products/product-1763521632585/ao-khoac-nam-AKM7007-DEN_62ea6044.webp\" alt=\"\">','https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521691/products/ao-khoac-nam-AKM7007-GHI_958c9867.jpg',_binary '','Ão KhoÃ¡c Nam MÅ© Liá»n LÃ³t LÃ´ng',300000.00,290000.00,0,0,'ao-khoac-nam-mu-lien-lot-long',_binary '','Ão KhoÃ¡c Nam MÅ© Liá»n LÃ³t LÃ´ng','TRENDING',0,26,_binary '\çMøÁ²gğ“VŠµ£§',_binary 'ˆ‘	5£\ßO—]R¸Ğš/®');
...
INSERT INTO `product_discount` VALUES (_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\Ì\ëš\éCi®¯¯–\Zc'),(_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\Ì\ëš\éCi®¯¯–\Zc'),(_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '~DqX¶ŠIg‚}V\Î+]±');
...
INSERT INTO `product_image` VALUES (_binary '¬\æÚ‡H@£Drÿ','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',1,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521893/products/ao-phao-nam-PHM7009-REU-2_718e090a.webp',_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '!¾‘œòBE™ôii„€¡','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',0,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522101/products/quan-kaki-nam-QKM6017-XAM-1_fec0bf1d.webp',_binary '\Â\ÇÅ¥²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'N-ÁFH¾¬\å”Jª!','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',4,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521893/products/ao-phao-nam-PHM7009-XDE-5_1396731f.webp',_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '\"\Ø\ÍiYó@J´.¸k\Z#','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',3,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521892/products/ao-phao-nam-PHM7009-XDE-4_4d3155bd.webp',_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '$\ç6‚·B7Šñ†¹C\ÙXœ','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',4,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521683/products/ao-khoac-nam-AKM7007-DEN-4_9154de45.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '/\å\ÒCÙ‰AÀœ\á#<«S°','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',3,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522101/products/quan-kaki-nam-QKM6017-DEN-4_d0dcfc13.webp',_binary '\Â\Ç\ÅÛ²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '8¡\0³•®Jv”c%*\0A','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',3,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521892/products/ao-phao-nam-PHM7009-REU-4_99d1ee08.webp',_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '=»\ß5ùB3‡Z+w$—\ÚG','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',5,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521686/products/ao-khoac-nam-AKM7007-GHI-5_9ed0a255.webp',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary 'A\Å‹r@—ˆgh»u‚OJ','2025-11-19 10:14:23.791912',NULL,NULL,_binary '',0,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521890/products/ao-phao-nam-PHM7009-REU-1_041c4316.webp',_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'AJ¾\é\ÔıG¸»7\ç…K%\Î','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',4,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522103/products/quan-kaki-nam-QKM6017-XAM-5_53079c2b.webp',_binary '\Â\ÇÅ¥²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'AĞ¯/öòNÔ™f«’·¥','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',6,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521679/products/ao-khoac-nam-AKM7007-DEN-6_c1c0ec89.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'E5óJCKTdW$\êt(','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',3,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521685/products/ao-khoac-nam-AKM7007-GHI-3_8ca79bac.webp',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary 'Kq¸´GBó§8nk\ß-B','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',3,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521686/products/ao-khoac-nam-AKM7007-DEN-3_e11918fc.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'R–\ì\\±KwŒÿ§Ò¸ûn½','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',2,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522103/products/quan-kaki-nam-QKM6017-XAM-3_ac774a03.webp',_binary '\Â\ÇÅ¥²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '\\ŒOô4K!¥“a<²½@–','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',1,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521684/products/ao-khoac-nam-AKM7007-GHI-1_e4aaa4d4.webp',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary ']”qÃ„N\ãC\æ:t\î–','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',2,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521892/products/ao-phao-nam-PHM7009-REU-3_e71a8072.webp',_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'b\ÃñˆMN§›3‰3:|ªŒ','2025-11-19 10:09:39.108595',NULL,NULL,_binary '',0,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521691/products/ao-khoac-nam-AKM7007-GHI_958c9867.jpg',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary 'f»9òİŠM–ƒ\r\È\'ü','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',5,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521889/products/ao-phao-nam-PHM7009-REU-6_5989b61c.webp',_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'i»¨ğ©Aş³\Ú	ˆ4®’','2025-11-19 10:17:35.248083',NULL,NULL,_binary '',0,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522101/products/quan-kaki-nam-QKM6017-DEN-1_fdbfbe1f.webp',_binary '\Â\Ç\ÅÛ²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '…X}—9Lq¼õ¼\Ğ5_ŠG','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',4,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521685/products/ao-khoac-nam-AKM7007-GHI-4_37d1b8bd.webp',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary '‘ñ’9wF×´¿\'}Šªƒn','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',2,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521682/products/ao-khoac-nam-AKM7007-DEN-2_8161ea18.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '•†GùO\à,ªZ¨%;','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',5,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521893/products/ao-phao-nam-PHM7009-XDE-6_2af76a07.webp',_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '•À#‰\î)JÄƒhbM˜™f','2025-11-19 10:17:35.250086',NULL,NULL,_binary '\0',5,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522104/products/quan-kaki-nam-QKM6017-XAM-6_10a3e918.webp',_binary '\Â\ÇÅ¥²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'œ¢CYºKd£ŠóP\êóC6','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',2,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522103/products/quan-kaki-nam-QKM6017-DEN-3_ec8ce7e3.webp',_binary '\Â\Ç\ÅÛ²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '¥i`‚Kƒ˜Sg\è\ØG','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',1,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521892/products/ao-phao-nam-PHM7009-XDE-2_d6f1e9ec.webp',_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '§ûó]gB©«`\ål‡f','2025-11-19 10:17:35.249093',NULL,NULL,_binary '',3,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522103/products/quan-kaki-nam-QKM6017-XAM-4_298c8d5f.webp',_binary '\Â\ÇÅ¥²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '¨3S¿\ÇHl™c\Í\Øÿ™\È','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',4,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522101/products/quan-kaki-nam-QKM6017-DEN-6_e0466db7.webp',_binary '\Â\Ç\ÅÛ²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '«3\ã\Ò£LÜ°?-\Ì²2\æ','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',6,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521686/products/ao-khoac-nam-AKM7007-GHI-6_64244992.webp',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary 'µ5\ÎØDÔı\Ş7|P\Ğ','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',6,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521891/products/ao-phao-nam-PHM7009-REU-7_92237abc.jpg',_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '\Å\ál\è\àI	¼E\Æü\Ï\ÃQ','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',1,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521683/products/ao-khoac-nam-AKM7007-DEN-1_7405f1f5.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '\Ïÿ\0o0H§³‡^µjo¸','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',1,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522101/products/quan-kaki-nam-QKM6017-DEN-2_a8630bb2.webp',_binary '\Â\Ç\ÅÛ²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'Ğ©Ò«*{Fõ‘”ƒ/_','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',5,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521683/products/ao-khoac-nam-AKM7007-DEN-5_2402d311.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '\ÕÆ¸NM^‡mP\ÏB»­:','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',4,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521889/products/ao-phao-nam-PHM7009-REU-5_7d027d13.webp',_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '\ÕòŞ³·\ZAñ–F’;™¼Û“','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',7,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521686/products/ao-khoac-nam-AKM7007-GHI-7_ef0b2612.webp',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary '\Ûõ9«WA‘ˆD±ü¹qxü','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',7,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521683/products/ao-khoac-nam-AKM7007-DEN-7_133e0b0d.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'Ü”\×=VL&”¯\äh \Æ','2025-11-19 10:09:39.108595',NULL,NULL,_binary '',0,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521682/products/ao-khoac-nam-AKM7007-DEN_f7cfcf97.webp',_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§'),(_binary '\àÿR¡D«H\×.¤O','2025-11-19 10:09:39.108595',NULL,NULL,_binary '\0',2,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521684/products/ao-khoac-nam-AKM7007-GHI-2_b9b32a43.webp',_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§'),(_binary 'ó| d\Ç:D\Z–6IE’\Ğ','2025-11-19 10:17:35.249093',NULL,NULL,_binary '\0',1,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763522103/products/quan-kaki-nam-QKM6017-XAM-2_b5a29331.webp',_binary '\Â\ÇÅ¥²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'öYrQD_Ÿv„A\æò»<','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',2,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521892/products/ao-phao-nam-PHM7009-XDE-3_7e20cacd.webp',_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'ù]m0HyUdg˜±š<','2025-11-19 10:14:23.791912',NULL,NULL,_binary '\0',6,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521894/products/ao-phao-nam-PHM7009-XDE-7_1f28f3ca.webp',_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§'),(_binary 'û\ZM\ã\æšK\n”Ò§&	S]','2025-11-19 10:14:23.791912',NULL,NULL,_binary '',0,'https://res.cloudinary.com/dwyjwk0mf/image/upload/v1763521892/products/ao-phao-nam-PHM7009-XDE-1_d353d9e5.webp',_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§');
...
INSERT INTO `product_product_variants` VALUES (_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary ':EüR\'RJc¡\æöVt\â4'),(_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '‹@›´\ZUK.¾\ëÙŒ\Óp|„'),(_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary 'N´\İn‡H\à‹\Ï\Ò)²]\Õ'),(_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary 'z3%\Ë3Dı˜„¶pA¯²\Ò'),(_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '*\Û)\Ï6O`–MNW›G–¿'),(_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary ' ¢¢´AE@’~£“q\ê\Î');
...
INSERT INTO `product_variant` VALUES (_binary '*\Û)\Ï6O`–MNW›G–¿','QSR780-TRáº®NG-M',0,280000.00,18,_binary '\Â\Ç\Æ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉB	²gğ“VŠµ£§',290000.00),(_binary ':EüR\'RJc¡\æöVt\â4','VGC981-XÃM-L',1,280000.00,17,_binary '\Â\ÇÅ¥²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§',350000.00),(_binary 'N´\İn‡H\à‹\Ï\Ò)²]\Õ','RDB405-XANH ÄEN-L',1,294000.00,20,_binary '\ÂÇºQ²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§',304000.00),(_binary 'z3%\Ë3Dı˜„¶pA¯²\Ò','RDB405-NÃ‚U Äáº¬M-L',0,294000.00,20,_binary '\Â\ÇÀ(²fğ“VŠµ£§',_binary 'š»¾A£JrŒÎ…JB\ÔbÁ',_binary '\ÉM%²gğ“VŠµ£§',304000.00),(_binary '‹@›´\ZUK.¾\ëÙŒ\Óp|„','VGC981-XÃM Äáº¬M-L',0,280000.00,10,_binary '\Â\Ç\ÅÛ²fğ“VŠµ£§',_binary 'l\ákE-ıNn€\æ˜5;1\n¹',_binary '\ÉM%²gğ“VŠµ£§',350000.00),(_binary ' ¢¢´AE@’~£“q\ê\Î','QSR780-ÄEN-L',1,280000.00,20,_binary '\Â\Ç\ÄÈ²fğ“VŠµ£§',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '\ÉM%²gğ“VŠµ£§',290000.00);
...
INSERT INTO `review` VALUES (_binary 'cò~On¼Hsµ8q²şÁ,','2025-11-20 11:44:12.489120',NULL,NULL,'Sáº£n pháº©m Ä‘Ãºng mÃ´ táº£, shop giao nhanh !',_binary '',_binary '',4,_binary '\á\ÆÏ¼=GgŠi\Ğö™®™',_binary '\Ï(„!9FçŠ§\nGCm\Û4',_binary '¥øh|¨L\Z˜r¡c¨');
...
INSERT INTO `review_media` VALUES (_binary 'cò~On¼Hsµ8q²şÁ,','https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.thietkeshopee.net%2F2023%2F06%2Fchuan-bi-hang-dong-goi-hang'),(_binary 'cò~On¼Hsµ8q²şÁ,','https://www.google.com/url?sa=i&url=https%3A%2F%2Fmaydonggoi.com.vn%2Fcach-dong-goi-hang');
...
CREATE TABLE `sub_themes` (
  ...
  CONSTRAINT `FKduq2fdjwfbbkhy0w4hbapcn07` FOREIGN KEY (`collection_id`) REFERENCES `collection_tb` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `trigger_keywords`
--

DROP TABLE IF EXISTS `trigger_keywords`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trigger_keywords` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKqbl3hnnw9nf68blwujqqoug2` (`keyword`,`rule_id`),
  KEY `FK9htdq4yqluojyhgmrvtdn2c7o` (`rule_id`),
  CONSTRAINT `FK9htdq4yqluojyhgmrvtdn2c7o` FOREIGN KEY (`rule_id`) REFERENCES `auto_reply_config` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trigger_keywords`
--

LOCK TABLES `trigger_keywords` WRITE;
/*!40000 ALTER TABLE `trigger_keywords` DISABLE KEYS */;
INSERT INTO `trigger_keywords` VALUES (_binary 'T’Œñ6D-¹g \ä*\Ø8\Ğ','chÃ o',_binary 'ˆ¡cZ¾VOÛœ”y\Ú\ë\Ç\ê\Ü'),(_binary '\ëˆñY\ê\ÉGP´£\Ò&´½@','háº¿ lÃ´',_binary 'ˆ¡cZ¾VOÛœ”y\Ú\ë\Ç\ê\Ü'),(_binary '\ÈˆhhCÊµ$\0>\ÌY…','hello',_binary 'ˆ¡cZ¾VOÛœ”y\Ú\ë\Ç\ê\Ü'),(_binary '´8U´G]OF q®z %±\Ø','hi',_binary 'ˆ¡cZ¾VOÛœ”y\Ú\ë\Ç\ê\Ü'),(_binary 'œ\Ö^g†\ïG,¢˜§WUSb','xin chÃ o',_binary 'ˆ¡cZ¾VOÛœ”y\Ú\ë\Ç\ê\Ü');
/*!40000 ALTER TABLE `trigger_keywords` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (_binary '¬\ÏÙŸıA„J“\áø¹?','2025-10-26 11:30:30.500000',NULL,'2025-10-26 11:34:07.988000',NULL,NULL,'admin@gmail.com',_binary '','Admin','Trendista',_binary '\0','{bcrypt}$2a$10$TpNtNA5JR5l3nQktkAbIGe1PvUTjrxI7h.Tc.fuVrfIby.CsNf87C','0987654321','MANUAL',NULL),(_binary '¥øh|¨L\Z˜r¡c¨','2025-10-26 13:00:24.728000',NULL,'2025-11-01 21:54:20.444000','https://cellphones.com.vn/sforum/wp-content/uploads/2024/01/anh-meme-63.jpg',NULL,'user@gmail.com',_binary '','User','Trendista',_binary '\0','{bcrypt}$2a$10$hPdAuV9ZSTRpjoML/yIyTOzcixnRs/ifyIYNvmSWTj1t69uy9nwiy','0987654321','MANUAL',NULL),(_binary '\ãu(Gˆ¢U\r–%¦²','2025-11-06 14:23:53.161150',NULL,NULL,NULL,NULL,'system@trendista.shop',_binary '','Trendista','Shop',_binary '\0',NULL,NULL,'MANUAL',NULL),(_binary '^bn7M×£/L\æJ^\Ï','2025-10-30 10:29:13.118000',NULL,NULL,'https://lh3.googleusercontent.com/a/ACg8ocLtw6BF2XTZuvS_asHIyvXphHhR4UJw4NXZm0ZpPvbtQ3cZH7c=s96-c',NULL,'vipboy15102002@gmail.com',_binary '','Lá»™c','Leo',_binary '\0',NULL,NULL,'GOOGLE',NULL),(_binary 'bø\r	\ĞI¡‹ |¥t\Ş','2025-11-04 21:19:14.937945',NULL,'2025-11-04 21:20:14.840095',NULL,NULL,'trolytrendista@gmail.com',_binary '','Chat','Trendista',_binary '\0','{bcrypt}$2a$10$kXdJcrw7q4xtYCfXtlgqO.OLczSzzdfR1TPc2l.dOBCt8QTKGiVTG','0947463675','MANUAL',NULL),(_binary '\çğ¨	HÏ‚f)3\Èöaõ','2025-10-31 14:07:15.912000',NULL,'2025-10-31 14:08:29.697000',NULL,NULL,'hhgiang0508@gmail.com',_binary '','Ho Thi','Huong Giang',_binary '\0','{bcrypt}$2a$10$53PRXvotoGw4y00DMnCnEeS7jMZ1Q5cwRyF21e5XQgNG/ecYLSzmy','0987654321','MANUAL',NULL);
...
INSERT INTO `verification_attempts` VALUES (_binary '1OJÀqOI›•„}€o','2025-11-04 21:19:15.856381',NULL,NULL,'trolytrendista@gmail.com','eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJ0cmVuZGlzdGFTaG9wIiwic3ViIjoidHJvbHl0cmVuZGlzdGFAZ21haWwuY29tIiwiaWF0IjoxNzYyMjY1OTU1LCJleHAiOjE3NjIzNTIzNTUsInR5cGUiOiJ2ZXJpZmljYXRpb24ifQ.t5lEXFif3HJGahhhjncl2u73ZxFcIfW4RXt9c5fxjOM',_binary 'bø\r	\ĞI¡‹ |¥t\Ş'),(_binary 'e´G®~EM‡¾£¬\\ò(\Æ','2025-10-26 11:30:30.912000',NULL,NULL,'admin@gmail.com','eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJ0cmVuZGlzdGFTaG9wIiwic3ViIjoiYWRtaW5AZ21haWwuY29tIiwiaWF0IjoxNzYxNDc4MjMwLCJleHAiOjE3NjE1NjQ2MzAsInR5cGUiOiJ2ZXJpZmljYXRpb24ifQ.yK5m7KxiKpOMmAaDzDCOV7r6WdiqW9ynTk4C4aTfmDQ',_binary '¬\ÏÙŸıA„J“\áø¹?'),(_binary 'u\0òeƒH†‡~\àc^','2025-10-26 13:00:24.877000',NULL,NULL,'user@gmail.com','eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJ0cmVuZGlzdGFTaG9wIiwic3ViIjoidXNlckBnbWFpbC5jb20iLCJpYXQiOjE3NjE0ODM2MjQsImV4cCI6MTc2MTU3MDAyNCwidHlwZSI6InZlcmlmaWNhdGlvbiJ9.MWeb-4DxO3J1UzhvWQQYNmKmJk5Z00LNwgm2E9dsraY',_binary '¥øh|¨L\Z˜r¡c¨'),(_binary '{;2»fHR¦,\'ı$','2025-10-31 14:07:16.331000',NULL,NULL,'hhgiang0508@gmail.com','eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJ0cmVuZGlzdGFTaG9wIiwic3ViIjoiaGhnaWFuZzA1MDhAZ21haWwuY29tIiwiaWF0IjoxNzYxODk0NDM2LCJleHAiOjE3NjE5ODA4MzYsInR5cGUiOiJ2ZXJpZmljYXRpb24ifQ.jQ2SnymKn5PBxP6nE9wC7s_6byMuqp6a0Pdo2F-hPGs',_binary '\çğ¨	HÏ‚f)3\Èöaõ');
